...
var _vertSource = require("./shader/vertSource");

var _vertSource2 = _interopRequireDefault(_vertSource);

var _fragSource = require("./shader_02/fragSource");

var _fragSource2 = _interopRequireDefault(_fragSource);
...
var WebGL = function () {
  function WebGL() {
    ...
    // シェーダーに渡す uniform 変数
    this.uniforms = (0, _glUtil.createUniforms)(this.pxRatio);
    var w = this.uniforms.resolution.val.x;
    var h = this.uniforms.resolution.val.y;
    ...
    var vShader = (0, _glUtil.createShaderFromSource)(this.gl, _vertSource2.default, this.gl.VERTEX_SHADER);
    var fShader = (0, _glUtil.createShaderFromSource)(this.gl, _fragSource2.default, this.gl.FRAGMENT_SHADER);

    // プログラムオブジェクトの生成とリンク
    var prg = (0, _glUtil.createProgram)(this.gl, vShader, fShader);
    ...
    // 頂点情報( x, y, z )
    var position = [-1.0, 1.0, 0.0, // 0 : top    left
    ...
    // 頂点VBO生成
    var positionVbo = (0, _glUtil.createVbo)(this.gl, position);
    ...
    // IBO生成
    var ibo = (0, _glUtil.createIbo)(this.gl, index);

    // VBOをバインド ( VBO, attributeLocation, attributeStride )
    (0, _glUtil.setAttribute)(this.gl, [positionVbo], [attLocation], [3]);
  ...
  _createClass(WebGL, [{
    ...
    value: function render(timeStamp) {
      ...
      // uniform 変数更新
      (0, _glUtil.setUniforms)(this.gl, this.uniforms);
    ...
    key: "onResize",
    value: function onResize(_e) {
      var w = window.innerWidth * this.pxRatio;
      var h = window.innerHeight * this.pxRatio;
...
},{"./glUtil":3,"./shader/vertSource":5,"./shader_02/fragSource":6}],3:[function(require,module,exports){
"use strict";
...
//--------------------------------------------------
var createShaderFromSource = exports.createShaderFromSource = function createShaderFromSource(_gl, _source, _type) {
...
//--------------------------------------------------
var createProgram = exports.createProgram = function createProgram(_gl, _vs, _fs) {
  // プログラムオブジェクトを生成
...
//--------------------------------------------------
var createVbo = exports.createVbo = function createVbo(_gl, _data) {
  // バッファオブジェクトを生成
...
//--------------------------------------------------
var setAttribute = exports.setAttribute = function setAttribute(_gl, _vbo, _attL, _attS) {
  for (var i in _vbo) {
    // VBOをバインド
...
//--------------------------------------------------
var createIbo = exports.createIbo = function createIbo(_gl, _data) {
  // バッファオブジェクトを生成
...
// createUniforms
//--------------------------------------------------
var createUniforms = exports.createUniforms = function createUniforms() {
  var pxRatio = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
...
// setUniforms
//--------------------------------------------------
var setUniforms = exports.setUniforms = function setUniforms(_gl, _uniforms) {
...
var init = function init(_) {
  var wgl = new _WebGL2.default();
  console.log(wgl);

  var gui = new dat.GUI();
  var folder = gui.addFolder("LightScale");
...
},{"./WebGL":2,"dat.gui":1}],5:[function(require,module,exports){
"use strict";
